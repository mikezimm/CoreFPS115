...
import { exportIgnorePropsWP, importBlockPropsWP, WebPartAnalyticsChanges, WebPartPanelChanges,  } from './IFpsCore115BannerWebPartProps';
...
export default class FpsCore115BannerWebPart extends FPSBaseClass<IFpsCore115BannerWebPartProps> {
